...
##
## COMMAND ROUTING
##   handle_command()                    - Line 50 (main router)
##   _success() / _error()               - Line 260 (response helpers)
##
## STATUS & INFO COMMANDS                - Line 280
##   _cmd_get_status()                   - Get Godot/plugin status
##   _cmd_play_main_scene()              - Play main scene
##   _cmd_play_current_scene()           - Play current scene
##   _cmd_stop_scene()                   - Stop running game
##   _cmd_is_playing()                   - Check if playing
##   _cmd_get_debug_output()             - Get debug logs
##   _cmd_clear_debug_log()              - Clear debug log
##   _cmd_get_debugger_status()          - Debugger diagnostics
##   _cmd_get_editor_log()               - Read editor log file
##
## GAME CONTROL COMMANDS                 - Line 640
##   _cmd_play_custom_scene()            - Play specific scene
##
## SCENE TREE COMMANDS                   - Line 655
##   _cmd_get_scene_tree()               - Get scene hierarchy
##   _cmd_get_node_info()                - Get node details
##   _cmd_get_node_properties()          - Get node properties
##
## FILE OPERATIONS                       - Line 830
##   _cmd_get_project_files()            - List project files
##   _cmd_read_file()                    - Read file contents
##   _cmd_write_file()                   - Write file contents
##   _cmd_file_exists()                  - Check file exists
##
## SCENE OPERATIONS                      - Line 930
##   _cmd_open_scene()                   - Open scene file
##   _cmd_save_scene()                   - Save current scene
##   _cmd_save_all_scenes()              - Save all scenes
##   _cmd_get_open_scenes()              - List open scenes
##
## EDITOR OPERATIONS                     - Line 1030
##   _cmd_get_selected_nodes()           - Get selected nodes
##   _cmd_select_node()                  - Select a node
##   _cmd_get_editor_settings()          - Get editor settings
##   _cmd_get_editor_state()             - Get comprehensive state
##   _cmd_get_unsaved_changes()          - Check unsaved changes
##
## SCRIPT OPERATIONS                     - Line 1165
##   _cmd_get_script_errors()            - Check script errors
##   _cmd_open_script()                  - Open script in editor
##
## PROJECT INFO                          - Line 1215
##   _cmd_get_project_settings()         - Get project settings
##   _cmd_list_resources()               - List resources
##
## NODE MANIPULATION                     - Line 1280
##   _cmd_create_node()                  - Create new node
##   _cmd_delete_node()                  - Delete node
##   _cmd_set_node_property()            - Set property
##   _cmd_rename_node()                  - Rename node
##   _cmd_move_node()                    - Move/reparent node
##   _cmd_duplicate_node()               - Duplicate node
##
## SCENE CREATION                        - Line 1640
##   _cmd_create_scene()                 - Create new scene
##   _cmd_new_inherited_scene()          - Create inherited scene
##
## INPUT SIMULATION                      - Line 1740
##   _cmd_simulate_key()                 - Simulate keyboard
##   _cmd_simulate_mouse_button()        - Simulate mouse click
##   _cmd_simulate_mouse_motion()        - Simulate mouse move
##   _cmd_simulate_action()              - Simulate input action
##   _cmd_get_input_actions()            - List input actions
##
## GUT TESTING                           - Line 2050
##   _cmd_gut_run_all()                  - Run all tests
##   _cmd_gut_run_script()               - Run test file
##   _cmd_gut_run_test()                 - Run single test
##   _cmd_gut_get_results()              - Get test results
##   _cmd_gut_list_tests()               - List available tests
##   _cmd_gut_create_test()              - Create test file
##   _cmd_gut_check_installed()          - Check GUT installed
##
## SIGNAL OPERATIONS                     - Line 2410
##   _cmd_list_node_signals()            - List node signals
##   _cmd_emit_signal()                  - Emit signal
##
## METHOD OPERATIONS                     - Line 2510
##   _cmd_call_method()                  - Call node method
##   _cmd_list_node_methods()            - List node methods
##
## GROUP OPERATIONS                      - Line 2595
##   _cmd_get_nodes_in_group()           - Get nodes in group
##   _cmd_add_node_to_group()            - Add to group
##   _cmd_remove_node_from_group()       - Remove from group
##
## RESOURCE OPERATIONS                   - Line 2710
##   _cmd_load_resource()                - Load resource
##   _cmd_get_resource_info()            - Get resource info
##
## ANIMATION OPERATIONS                  - Line 2785
##   _cmd_list_animations()              - List animations
##   _cmd_play_animation()               - Play animation
##   _cmd_stop_animation()               - Stop animation
##
## AUDIO OPERATIONS                      - Line 2910
##   _cmd_list_audio_buses()             - List audio buses
##   _cmd_set_audio_bus_volume()         - Set bus volume
##   _cmd_set_audio_bus_mute()           - Mute/unmute bus
##
## DEBUG/PERFORMANCE                     - Line 3020
##   _cmd_get_performance_info()         - Get performance stats
##   _cmd_get_memory_info()              - Get memory usage
##   _cmd_print_to_console()             - Print to console
##   _cmd_get_recent_errors()            - Get recent errors
##
## PLUGIN MANAGEMENT                     - Line 3100
##   _cmd_enable_plugin()                - Enable plugin
##   _cmd_disable_plugin()               - Disable plugin
##   _cmd_get_plugins()                  - List plugins
##   _cmd_reload_project()               - Reload project
##
## ADVANCED TESTING & DEBUGGING          - Line 3290
##   _cmd_run_and_capture()              - Run and capture output
##   _cmd_wait_for_output()              - Wait for specific output
##   _cmd_ping_game()                    - Ping running game
##   _cmd_get_game_state()               - Get game state
##   _cmd_take_screenshot()              - Take screenshot
##
## ENHANCED GUT TESTING                  - Line 3570
##   _cmd_gut_run_and_wait()             - Run tests and wait
##   _cmd_gut_get_summary()              - Get test summary
##
## =============================================================================
